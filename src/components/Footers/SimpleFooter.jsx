            ...
            <Row>
              ...
              <Col xs="12" md="6" lg="6">
                <div className=" footer-contact">
                  702 (L), Hubtown Solaris, NS Phadke Marg,
                  <br />
                  Andheri East West Flyover Andheri East,
                  <br />
                  Mumbai, Maharashtra 400069
                  <br />
                  <i class="fa fa-map-marker"></i>&nbsp;
                  <a href="https://g.page/financelookup?share" target="_blank">
                    Find us on Map
                  </a>
                  <br />
                  <a href="tel: +91 9930854822">Phone: +91-9967110003</a>
                  <br />
                  <a href="mailto: contact@flookup.com">
                    Email: contact@flookup.com
                  </a>
                </div>
              </Col>
            </Row>
